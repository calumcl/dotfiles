...
def key_bindings(layout: Layout) -> list[tuple[str, Callable[[], Any]]]:
    return [
        ...
        ("XF86AudioRaiseVolume", lambda: os.system("amixer sset Master 3%+ && paplay /usr/share/sounds/gnome/default/alerts/drip.ogg")),
        ("XF86AudioLowerVolume", lambda: os.system("amixer sset Master 3%-&& paplay /usr/share/sounds/gnome/default/alerts/drip.ogg")),
